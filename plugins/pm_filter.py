...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        ...
        caption=f"<b>📍Hello:-{msg.from_user.id} നിങ്ങൾ ചോദിച്ച മൂവി വേണമെങ്കിൽ മുകളിലെ വീഡിയോ കണ്ട് അത് പോലെ സ്പെല്ലിങ് തെറ്റാതെ അയക്കുക.😌</b>",
    ...
    k = await msg.reply_photo(
        ...
        caption=f"<b>📍ഹലോ {msg.from_user.id} നിങ്ങളുടെ സിനിമ ഇതിലുണ്ടോന്ന് പരിശോധിക്കുക</b>",
